...
describe ContaCorrente do
    describe 'Saque' do
        ...
        context 'quando supera o limite de saque' do
           ...
           it 'então exibe mensagem' do 
              expect(@cc.mensagem).to eql 'Limite máximo por saque é €700'
           end
...
#rspec spec/saque_cc_spec.rb -fd
#relatorio : rspec --format html --out report.html
# rspec --format RspecJunitFormatter --out report.xml com ou sem -fd